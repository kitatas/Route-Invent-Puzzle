...
{
    public sealed class InformationInstaller : LifetimeScope
    {
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            {
                entryPoints.Add<InformationModalPresenter>();
            });

            // View
            builder.RegisterInstance<InformationModalView>(informationModalView);
        }
    }
}